...
public class BeerClientMockTest {
    ...
    @Autowired
    @Qualifier("oAuth2AuthorizedClientManager") // Chỉ định bean mock
    ...
    public static class TestConfig {
        ...
        @Bean
        OAuthClientInterceptor oAuthClientInterceptor(@Qualifier("oAuth2AuthorizedClientManager") OAuth2AuthorizedClientManager manager, ClientRegistrationRepository clientRegistrationRepository){
